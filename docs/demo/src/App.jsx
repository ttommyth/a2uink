...
export default function App() {
  ...
  const currentSurfaceIdRef = useRef("demo");
  ...
  const renderFromText = (text) => {
    ...
    try {
      ...
      termInstanceRef.current.write(`\x1b[31mInvalid JSON: ${error.message}\x1b[0m\r\n`);
      return;
    }
    ...
    const surfaceId = json.surfaceId || "demo";
  ...
  "props": {
    ...
    "onSelect": { "actionId": "colorChange" }
            ...
            <div className="terminal-preview" data-component="select">
              <div className="terminal-output">
                <pre>Select: <span className="term-cyan">Red</span>
  Green
  Blue</pre>
              </div>
            </div>
  ...
  "props": {
    ...
    "onChange": { "actionId": "toggleNotifications" }
            ...
            <div className="terminal-preview" data-component="checkbox">
              <div className="terminal-output">
                <span className="term-green">[✓]</span> Enable notifications
              </div>
            </div>
          </div>
        </section>
  ...
  "props": {
    ...
    "onChange": { "actionId": "sizeChange" }
            ...
            <div className="terminal-preview" data-component="radiogroup">
              <div className="terminal-output">
                <pre>  Small
<span className="term-cyan">(●)</span> Medium
  Large</pre>
              </div>
            </div>
          </div>
  ...
  "children": {
    "explicitList": ["panel1", "panel2", "panel3"]
            ...
            <div className="terminal-preview" data-component="tabs">
              <div className="terminal-output">
                <pre><span className="term-cyan">[Overview]</span> [Settings] [Help]
─────────────────────────────
Welcome to the overview panel!</pre>
              </div>
            </div>
          </div>
        </section>
...
│ Name     │ Status │
├──────────┼────────┤
│ API      │ <span className="term-green">OK</span>     │
│ Database │ <span className="term-yellow">Warn</span>   │
│ Cache    │ <span className="term-green">OK</span>     │
└──────────┴────────┘</pre>
              </div>
            </div>
          </div>
